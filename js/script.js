...
const HutData = {
  'mazalat': {
    ...
    season: 'Цяла година',
    routes: [
      { name: 'Маршрут към връх Триглав', difficulty: 'Среден', duration: '4-5 часа', distance: '8 км' },
      { name: 'Маршрут към връх Ботев', difficulty: 'Труден', duration: '6-7 часа', distance: '12 км' },
      { name: 'Кръгов маршрут Мазалат', difficulty: 'Лек', duration: '3-4 часа', distance: '6 км' }
    ],
  ...
  'ribni-ezera': {
    ...
    season: 'Цяла година',
    routes: [
      { name: 'Маршрут към връх Мусала', difficulty: 'Труден', duration: '5-6 часа', distance: '10 км' },
      { name: 'Маршрут към Седемте езера', difficulty: 'Среден', duration: '3-4 часа', distance: '7 км' },
      { name: 'Кръгов маршрут Рибни Езера', difficulty: 'Лек', duration: '2-3 часа', distance: '5 км' }
    ],
  ...
  'vihren': {
    ...
    season: 'Цяла година',
    routes: [
      { name: 'Маршрут към връх Вихрен', difficulty: 'Труден', duration: '4-5 часа', distance: '9 км' },
      { name: 'Маршрут към връх Кутело', difficulty: 'Среден', duration: '3-4 часа', distance: '7 км' },
      { name: 'Маршрут към езеро Попово', difficulty: 'Лек', duration: '2 часа', distance: '4 км' }
    ],
  ...
  'yavorov': {
    ...
    season: 'Цяла година',
    routes: [
      { name: 'Маршрут към връх Вихрен', difficulty: 'Труден', duration: '6-7 часа', distance: '14 км' },
      { name: 'Маршрут към езеро Долното', difficulty: 'Среден', duration: '3-4 часа', distance: '8 км' },
      { name: 'Кръгов маршрут Яворов', difficulty: 'Лек', duration: '2-3 часа', distance: '6 км' },
      { name: 'Маршрут към връх Каменица', difficulty: 'Среден', duration: '4-5 часа', distance: '10 км' }
    ],
